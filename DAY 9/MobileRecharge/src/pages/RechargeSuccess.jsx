...
Mobile Number: ${rechargeData.mobileNumber}
Operator: ${rechargeData.operator.toUpperCase()}
Plan Amount: ₹${rechargeData.plan.price}
${rechargeData.discount ? `Discount: -₹${rechargeData.discount.discount}` : ''}
Final Amount: ₹${rechargeData.finalAmount}
Status: SUCCESS
========================
Thank you for using MobileRecharge!
  ...
  const handleShare = (platform) => {
    ...
    const message = `I just recharged my mobile for ₹${rechargeData.finalAmount} with ${rechargeData.operator.toUpperCase()}. Transaction ID: ${rechargeData.transactionId}. #MobileRecharge`;
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="text-center p-4 bg-gray-50 rounded-lg">
                <div className="text-2xl font-bold text-gray-800">₹{rechargeData.finalAmount}</div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="font-medium">{rechargeData.mobileNumber}</span>
              </div>
